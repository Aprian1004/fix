...
# set repo
wget -O /etc/apt/sources.list "https://github.com/Aprian1004/fix/raw/master/sources.list.debian7"
...
# install screenfetch
cd
wget 'https://github.com/Aprian1004/fix/raw/master/screenfetch-dev'
...
wget -O /etc/nginx/nginx.conf "https://github.com/Aprian1004/fix/raw/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Edited by Radh_syn</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://github.com/Aprian1004/fix/raw/master/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf
service php5-fpm restart
service nginx restart

#auto create user SSH
PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false ndr
echo "123n:$PASS" | chpasswd
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://github.com/Aprian1004/fix/raw/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://github.com/Aprian1004/fix/raw/master/mrtg-mem.sh"
...
curl "https://github.com/Aprian1004/fix/raw/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid3/squid.conf "https://github.com/Aprian1004/fix/raw/master/squid3.conf"
...
# install pptp vpn
wget https://github.com/Aprian1004/fix/raw/master/pptpinstall.sh
...
wget -O bench-network "https://github.com/Aprian1004/fix/raw/master/bench-network"
...
#wget -O userlimit.sh "https://raw.github.com/yurisshOS/fixos/master/userlimit.sh"
